...
DEFENSE_META_PARAMS = {
    ...
    "defense_meta_priors_rules": {
        ...
        "AtTheLevel": [
            ...
            {"key": "SHOT_3_OD", "mult": 0.96, "require_base_action": "PnR"},
            {"key": "SHOT_MID_PU", "mult": 0.96, "require_base_action": "PnR"},
            {"key": "TO_HANDLE_LOSS", "mult": 1.03, "require_base_action": "PnR"},
        ],
        "Blitz_TrapPnR": [
            {"key": "PASS_SHORTROLL", "min": 0.10, "require_base_action": "PnR"},
        ],
        ...
        "Switch_Everything": [
            {"key": "SHOT_POST", "mult": 1.06},
            {"key": "TO_HANDLE_LOSS", "mult": 1.03},
        ],
        "Switch_1_4": [
