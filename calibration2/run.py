...
from .report import summarize_alerts, build_matchup_alerts
...
def run_calibration2(
    *,
    ...
    combo_wl: Dict[str, Dict[str, float]] = { _combo_id(c): {"games": 0, "wins": 0, "pts_for": 0.0, "pts_against": 0.0, "poss": 0.0} for c in combos }
