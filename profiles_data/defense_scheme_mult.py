...
DEFENSE_SCHEME_MULT: Dict[str, Dict[str, Dict[str, float]]] = {
    ...
    "Switch_Everything": {"PnR": {"RESET_RESREEN":1.20, "TO_SHOT_CLOCK":1.12, "PASS_SHORTROLL":0.85, "SHOT_3_OD":1.10},
                          ...
                          "PostUp": {"SHOT_POST":1.28, "FOUL_DRAW_POST":1.15},
    ...
    "Hedge_ShowRecover": {"PnR": {"PASS_SHORTROLL":1.18, "PASS_KICKOUT":1.07, "RESET_RESREEN":1.06},
                          "PnP": {"SHOT_3_CS": 0.98, "PASS_KICKOUT": 1.03, "SHOT_RIM_LAYUP": 1.03},
                          "ISO": {"TO_HANDLE_LOSS":1.04, "PASS_KICKOUT":1.03, "SHOT_TOUCH_FLOATER":1.05},
                          "Drive": {"SHOT_TOUCH_FLOATER":1.06}},
    ...
    "AtTheLevel": {"PnR": {"PASS_SHORTROLL":1.25, "PASS_KICKOUT":1.12, "SHOT_3_OD":0.92, "SHOT_MID_PU":0.92, "SHOT_RIM_LAYUP":0.95, "TO_HANDLE_LOSS":1.06, "RESET_RESREEN":1.05, "RESET_HUB":1.05},
                  "PnP": {"PASS_KICKOUT": 1.06, "PASS_EXTRA": 1.04, "SHOT_3_CS": 0.98, "SHOT_3_OD": 0.95, "SHOT_MID_PU": 0.95, "TO_HANDLE_LOSS": 1.06, "RESET_RESREEN": 1.03},
                  "ISO": {"TO_HANDLE_LOSS":1.06, "PASS_KICKOUT":1.04, "SHOT_MID_PU":0.98, "SHOT_3_OD":0.98},
                  "DHO": {"RESET_REDO_DHO":1.10, "PASS_KICKOUT":1.06, "TO_HANDLE_LOSS":1.08},
                  "Drive": {"TO_CHARGE":1.05, "SHOT_TOUCH_FLOATER":1.05, "SHOT_RIM_LAYUP":0.94}},
    "Zone": {"Drive": {"SHOT_RIM_LAYUP":0.75, "PASS_EXTRA":1.15, "PASS_SKIP":1.20, "SHOT_3_CS":1.10, "TO_BAD_PASS":1.10},
